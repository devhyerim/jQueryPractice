...
<script type="text/javascript">
	...
	//    - 매개변수
	//      1) url: (String) POST 메소드로 연결하는 서버 측 URL
	//      2) data: (Object) 이름과 값의 쌍으로 프로퍼티를 가진 객체. 미리 구성 및 인코딩 된 쿼리 스트링
	//      3) callBack: (Function) 요청이 완료되면 호출되는 함수
	...
	$(function()
	{
		$("#sendButton").click(function()
		{
			...
			window.alert("결과 출력 전, 이 메시지가 먼저 출력된다.");
		});
	});
